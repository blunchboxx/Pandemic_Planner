...
struct dataInput {
    ...
    void readFile(ifstream& file, string path, unordered_map<string, unordered_map<string, Hospital>>& dataMap);
    //void readFileSet(ifstream& file, string path, unordered_map<string, unordered_set<pair<string, Hospital>, HospitalHash>>& dataSet);


    void printData(unordered_map<string, unordered_map<string, Hospital>>& dataMap);
